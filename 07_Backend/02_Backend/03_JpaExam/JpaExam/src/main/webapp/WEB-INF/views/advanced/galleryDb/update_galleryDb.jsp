...
<div class="container">
    <div>
        <form action="/advanced/galleryDb/edit/${galleryDb.uuid}"
              method="post"
            ...
            <input type="hidden" name="uuid" value="${galleryDb.uuid}">
            ...
            <div class="mb-3">
                ...
                <%--                   required : 필수 입력 (유효성 체크)--%>
                       required
                <%--                   value : 화면에 값이 보이는 속성--%>
                       value="${galleryDb.galleryTitle}"
                       placeholder="제목입력">
            </div>

            <%--            기존 이미지 보기 --%>
            <div class="mb-3 col-12" style="width: 18rem;">
                <img src="${galleryDb.galleryFileUrl}"
                     class="card-img-top"
                     alt="강의"/>
            </div>
