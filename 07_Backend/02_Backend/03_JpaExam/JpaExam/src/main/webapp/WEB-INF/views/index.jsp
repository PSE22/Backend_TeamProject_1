...
<%--TODO: fn lib import -> jsp에서 함수 사용가능하게 만듬 --%>
...
<%--    if(조건문)과 함께 사용--%>
<%--    사용법 :  <c:redirect url="이동 url"/>--%>
<%--    <c:redirect url="/basic/dept"/>--%>

<%--    TODO: 2) jn(funcion) 태그 라이브러리--%>
    <c:set var="chars" value="안녕하세요 홍길동입니다."/>
    <c:set var="name" value="홍길동"/>
    <h5>chars 에 name 의 값이 있으면 true , 없으면 false </h5>
    <%-- TODO: 사용법 : ${fn:contains(문자열,문자열2)}--%>
    <h5>contains : ${fn:contains(chars,name)}</h5>
<%--    결과 : 안녕하세요 홍길동입니다.(chars) 에 홍길동(name) 있어 true로 나옴--%>
