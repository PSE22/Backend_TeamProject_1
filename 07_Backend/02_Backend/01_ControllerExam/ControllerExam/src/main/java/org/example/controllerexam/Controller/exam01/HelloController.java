 ...
 *            return 문자열 : jsp 위치를 작성, jsp 결과가 웹브라우저에 출려고딤
 * <p>
 * ===========================================================
 * DATE            AUTHOR             NOTE
 * -----------------------------------------------------------
...
//  TODO : Model 구조 : (키, 값) 형태로 되어 있고(해쉬맵구조) 키를 jsp 로 전송할 수 있음
...
//                  함수명 : Hello2
    ...
    public String Hello2(Model model) {
        model.addAttribute("hello", "안녕 hello2 페이지");
        model.addAttribute("hello2", "Springboot 처음이지");
        model.addAttribute("hello3", "수고해!!!");

        return "/exam01/hello2.jsp";
}
...
//                      "EL 표현식이 있습니다. "
    ...
    public String Hello3(Model model) {
        model.addAttribute("hello", "안녕 JSP 페이지야");
        model.addAttribute("hello2", "JSP 에는 JSTL");
        model.addAttribute("hello3", "EL 표현식이 있습니다");

        return "/exam01/hello3.jsp";
    }
...
//        결과        : boolean(bFlag = true), int(iParam = 10),
