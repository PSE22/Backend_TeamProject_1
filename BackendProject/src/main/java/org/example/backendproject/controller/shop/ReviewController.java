...
import org.example.backendproject.service.shop.ReviewService;
...
//    TODO: 전체 조회 함수 + like 검색
    ...
    public ResponseEntity<Object> findAll(
            @RequestParam(defaultValue = "") Integer reviewId,
...
//            전체 조회 서비스 실행
            Page<IReviewDto> reviewDtoPage
                    = reviewService.selectByReviewContaining(reviewId, pageable);
